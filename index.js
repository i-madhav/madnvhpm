...
╚═╝░░╚═╝╚═╝  ░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚══════╝ ╚═╝╚═╝`.magenta)
    ...
    console.log()
    const spinner = createSpinner('Loading Madhav\'s details').start()
...
█▀▀ ██▄ █▀▄ ▄█ █▄█ █░▀█ █▀█ █▄▄   █▄▀ ██▄ ░█░ █▀█ █ █▄▄ ▄█`.yellow);
    ...
    const githubLink = link('btw its awesome -> ','https://github.com/i-madhav');
    const websiteLInk = link('Coolest thing -> ','https://pwerup.vercel.app/');
    console.log(`NAME    `.green + ' - ' + 'Madhav Sharma'.cyan);
...
console.log()
console.log('Madhav is up for hire, ready to help your company get to next heights and ofc Thanks for checking out my cli!'.magenta)
console.log()
}
